      ...
      <div className="min-h-screen flex bg-gray-100">
        <div className="flex flex-col w-1/4 bg-white shadow-md p-4">
          ...
          <ul className="space-y-2">
            <li>
              <button onClick={() => setPersonForm(!personForm)} className="btn btn-primary w-full">
                Add Person
              </button>
            </li>
            <li>
              <button onClick={() => setTaskForm(!taskForm)} className="btn btn-primary w-full">
                Suggest Task
              </button>
            </li>
            <li>
              <button className="btn btn-primary w-full">Complete Task</button>
            </li>
          </ul>
